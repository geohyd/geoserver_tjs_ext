...
public class TjsDescribeFrameworksXmlReader extends XmlRequestReader {
    ...
    public Object read(Object request, Reader reader, Map kvp) throws Exception {
        ...
        DescribeFrameworksType describeFrameworksType = tjsFactory.createDescribeFrameworksType();

        Node rootNode = document.getDocumentElement();
        Node nodeGetMap = rootNode;
        NamedNodeMap atts = nodeGetMap.getAttributes();
        if (getNodeValue(nodeGetMap, "FrameworkURI") != null) {
            describeFrameworksType.setFrameworkURI(getNodeValue(nodeGetMap, "FrameworkURI"));
        }
