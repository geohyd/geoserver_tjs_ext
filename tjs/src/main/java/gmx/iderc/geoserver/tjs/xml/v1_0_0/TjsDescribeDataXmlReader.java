...
public class TjsDescribeDataXmlReader extends XmlRequestReader {
    ...
    public Object read(Object request, Reader reader, Map kvp) throws Exception {
        ...
        DescribeDataType describeDataType = tjsFactory.createDescribeDataType();
        Node rootNode = document.getDocumentElement();
        Node nodeGetMap = rootNode;
        NamedNodeMap atts = nodeGetMap.getAttributes();
        if (getNodeValue(nodeGetMap, "FrameworkURI") != null) {
            describeDataType.setFrameworkURI(getNodeValue(nodeGetMap, "FrameworkURI"));
        }
        if (getNodeValue(nodeGetMap, "DatasetURI") != null) {
            describeDataType.setDatasetURI(getNodeValue(nodeGetMap, "DatasetURI"));
        }
        if (getNodeValue(nodeGetMap, "Attributes") != null) {
            describeDataType.setDatasetURI(getNodeValue(nodeGetMap, "Attributes"));
        }
