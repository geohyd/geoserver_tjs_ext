 ...
 */
public class TjsDescribeKeyXmlReader extends XmlRequestReader {
    Configuration configuration;
    private EntityResolverProvider resolverProvider;

    public TjsDescribeKeyXmlReader(
    ...
    public Object read(Object request, Reader reader, Map kvp) throws Exception {
        ...
        DescribeKeyType describeKeyType = tjsFactory.createDescribeKeyType();
        Node rootNode = document.getDocumentElement();
        Node nodeGetMap = rootNode;
        NamedNodeMap atts = nodeGetMap.getAttributes();
        if (getNodeValue(nodeGetMap, "FrameworkURI") != null) {
            describeKeyType.setFrameworkURI(getNodeValue(nodeGetMap, "FrameworkURI"));
        }
