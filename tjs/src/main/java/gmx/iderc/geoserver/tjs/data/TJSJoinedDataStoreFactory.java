...
/**
 * Created with IntelliJ IDEA. User: thijsb Date: 3/18/14 Time: 4:17 PM To change this template use
 * File | Settings | File Templates.
 */
// There seems to be some classes on TJSDataStores alreadye, but these are not for joined results it
// seems.
...
public class TJSJoinedDataStoreFactory implements DataStoreFactorySpi {
    ...
    public static final Param FRAMEWORKID =
            new Param("FrameworkId", String.class, "FrameworkId of TJS Framework", true);
    ...
    public DataStore createDataStore(Map<String, ?> params) throws IOException {
        ...
        TJS_1_0_0_DataStore newDataStore =
                new TJS_1_0_0_DataStore(tjsCatalog, featureDataStore, frameworkInfo);
        return newDataStore;
    }
    ...
    public String getDisplayName() {
        return "TJSJoinedData"; // To change body of implemented methods use File | Settings | File
        // Templates.
    }
