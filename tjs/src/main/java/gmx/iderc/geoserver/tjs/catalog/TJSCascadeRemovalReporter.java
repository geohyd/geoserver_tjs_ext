...
public class TJSCascadeRemovalReporter implements TJSCatalogVisitor {
     ...
     * removal. They are sorted from stronger to weaker.
     */
    ...
    /**
     * Adds a TJSCatalogObject into the objects map, eventually overriding the type if the
     * modification is stronger that the one already registered
     */
