...
public class DataStorePage extends GeoServerSecuredPage {
    ...
    public DataStorePage() {
        ...
        table =
                new GeoServerTablePanel<DataStoreInfo>("table", provider, true) {

                    @Override
                    protected Component getComponentForProperty(
                            String id,
                            IModel<DataStoreInfo> itemModel,
    ...
    private Component dataStoreLink(String id, final IModel model) {
        ...
        return new SimpleBookmarkableLink(
                id, DataStoreEditPage.class, nameModel, "name", (String) nameModel.getObject());
    }
