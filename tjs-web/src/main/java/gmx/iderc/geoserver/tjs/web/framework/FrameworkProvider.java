...
public class FrameworkProvider extends GeoServerDataProvider<FrameworkInfo> {
    ...
    static final Property<FrameworkInfo> FEATURE_TYPE =
            new AbstractProperty<FrameworkInfo>("featureType") {
    ...
    static final Property<FrameworkInfo> ENABLED =
            new AbstractProperty<FrameworkInfo>("enabled") {
