...
/**
 * Page listing all the available frameworks. Follows the usual filter/sort/page approach, provides
 * ways to bulk delete frameworks and to add new ones
 */
...
public class DatasetPage extends GeoServerSecuredPage {
    ...
    public DatasetPage() {
        ...
        table =
                new GeoServerTablePanel<DatasetInfo>("table", provider, true) {

                    @Override
                    protected Component getComponentForProperty(
                            String id,
                            IModel<DatasetInfo> itemModel,
                        ...
                        if (property == NAME) {
                            ...
                            if (refDate == null) return new Label(id);
                            else
                            ...
                            // resource/store
                            boolean enabled =
                                    ((Boolean) ENABLED.getModel(itemModel).getObject())
                                            .booleanValue();
                    ...
                    protected void onSelectionUpdate(AjaxRequestTarget target) {
                        ...
                        // target.addComponent((AjaxLink)removal);
                        target.add(removal);
                    }
                };
    ...
    private Component frameworkLink(String id, final IModel model) {
        ...
        return new SimpleBookmarkableLink(
                id, FrameworkEditPage.class, frameworkModel, "name", frameworkName);
    }
    ...
    private Component datasetLink(String id, final IModel model) {
        ...
        return new SimpleBookmarkableLink(id, DatasetEditPage.class, nameModel, params);
    }
    ...
    private Component dataStoreLink(String id, final IModel model) {
        ...
        return new SimpleBookmarkableLink(
                id, DataStoreEditPage.class, dataStoreModel, "name", dataStoreName);
    }
    ...
    // ResourceConfigurationPage.WORKSPACE, nsName);
    //        }else{
    //            return null;
    //        }
    //    }
