...
public class NewTJSDataPage extends TJSBasePage {
    ...
    public NewTJSDataPage() {
        ...
        if (!thereAreWorkspaces) {
            super.error(
                    (String)
                            new ResourceModel("NewTJSDataPage.noFrameworksErrorMessage")
                                    .getObject());
        }
        ...
        final ListView dataStoreLinks =
                new ListView("tjsResources", sortedDsNames) {
                    ...
                    protected void populateItem(ListItem item) {
                        ...
                        //                Image icon = new Image("tjsStoreIcon",
                        // icons.getStoreIcon(factory.getClass()));
                        //                // TODO: icons could provide a description too to be used
                        // in alt=...
                        //                icon.add(new AttributeModifier("alt", true, new
                        // Model("")));
                        //                item.add(icon);
                    }
                };
    ...
    private Map<String, TJSDataAccessFactory> getAvailableDataStores() {
        ...
        if (dataStores == null) {
            ...
            Map<String, TJSDataAccessFactory> storeNames =
