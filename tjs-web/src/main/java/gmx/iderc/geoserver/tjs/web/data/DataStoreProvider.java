...
public class DataStoreProvider extends GeoServerDataProvider<DataStoreInfo> {
    ...
    static final Property<DataStoreInfo> TYPE = new BeanProperty<DataStoreInfo>("type", "type");

    static final Property<DataStoreInfo> ENABLED =
            new AbstractProperty<DataStoreInfo>("enabled") {
