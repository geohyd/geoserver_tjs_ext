...
abstract class AbstractDataStorePage extends TJSBasePage {
    ...
    protected static final Logger LOGGER =
            Logging.getLogger("gmx.iderc.geoserver.tjs.web.data.datastore");
    ...
    protected void initUI(final DataStoreInfo storeInfo) throws IllegalArgumentException {
        ...
        try {
            ...
            String msg =
                    (String)
                            new ResourceModel("AbstractDataStorePage.cantGetDataStoreFactory")
                                    .getObject();
            msg += ": " + e.getMessage();
        ...
        //            workspacePanel = new WorkspacePanel("workspacePanel", wsModel, wsLabelModel,
        // true);
        //        }
        ...
        final DefaultDataStoreEditPanel storeEditPanel =
                new DefaultDataStoreEditPanel("parametersPanel", paramsForm);
        ...
        // .getFormComponent(), dataStoreNamePanel.getFormComponent(),
        // dataStoreInfoId);
    ...
    protected void clone(final DataStoreInfo source, DataStoreInfo target) {
        ...
        Map newparams =
                store.getDataStoreFactory().filterParamsForSave(source.getConnectionParameters());
