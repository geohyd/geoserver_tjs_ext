...
public class FrameworkPage extends GeoServerSecuredPage {
    ...
    public FrameworkPage() {
        ...
        table =
                new GeoServerTablePanel<FrameworkInfo>("table", provider, true) {

                    @Override
                    protected Component getComponentForProperty(
                            String id,
                            IModel<FrameworkInfo> itemModel,
    ...
    protected void onAfterRender() {
        super.onAfterRender();
        Logger.getLogger(FrameworkPage.class.getName())
                .log(Level.INFO, "Terminando Render de la pagina de Frameworks");
    }
    ...
    private Component frameworkLink(String id, final IModel model) {
        ...
        return new SimpleBookmarkableLink(
                id, FrameworkEditPage.class, nameModel, "name", (String) nameModel.getObject());
    }
