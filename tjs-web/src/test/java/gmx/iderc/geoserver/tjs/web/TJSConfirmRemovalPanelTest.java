...
public class TJSConfirmRemovalPanelTest extends TJSWicketTestSupport {
    ...
    public void testRemoveFramework() {
        ...
        //        String layers =
        // tester.getComponentFromLastRenderedPage("form:panel:removedObjects:layersRemoved:layers").getDefaultModelObjectAsString();
        //        String[] layerArray = layers.split(", ");
        //        DataStoreInfo citeStore = getCatalog().getStoreByName("cite",
        // DataStoreInfo.class);
        //        List<FeatureTypeInfo> typeInfos = getCatalog().getResourcesByStore(citeStore,
